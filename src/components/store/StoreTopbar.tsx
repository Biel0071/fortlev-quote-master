...
export function StoreTopbar({
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-40 w-full overflow-x-hidden border-b border-border bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/88">
      ...
      <div className={cn("w-full shrink-0", showCatalogChips ? "h-[176px] sm:h-[204px]" : "h-[132px] sm:h-[156px]")} aria-hidden="true" />
