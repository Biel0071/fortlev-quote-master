  ...
  if (slides.length === 0) {
    return (
      <div className="w-full overflow-hidden rounded-3xl border border-border bg-card">
        <div className="w-full aspect-[4/5] sm:aspect-auto sm:h-[300px] md:h-[380px] lg:h-[400px] xl:h-[420px] bg-muted flex items-center justify-center text-sm text-muted-foreground">
        ...
        <div className="flex">
          {slides.map((banner, index) => {
            ...
            const imageContent = desktopUrl || mobileUrl ? (
              ...
              <div className="w-full aspect-[4/5] sm:aspect-auto sm:h-[300px] md:h-[380px] lg:h-[400px] xl:h-[420px] bg-muted" />
            );
