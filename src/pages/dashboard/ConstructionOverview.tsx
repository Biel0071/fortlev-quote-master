...
import { BarChart3, DollarSign, Receipt, TrendingUp, Plus, Pencil, Copy, Trash2, FileText, Image, FileDown, Search, Eye, Truck } from "lucide-react";
                        ...
                        <TableCell className="text-center">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-56">
                              ...
                              <DropdownMenuItem onClick={() => navigate("/admin/dashboard/tracking", { state: { customer_name: q.customer.name, customer_cpf: q.customer.cpfCnpj, vinculo: 'existente', order_id: q.id, source: 'quotation' } })}>
